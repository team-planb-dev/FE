 ...
 *  [9-2] 빠른 수정 (393:10996 ~ 393:11110) — 요청 예시 버튼으로 시작하는 대화
 *  [9-3] 직접 수정 (393:12318 ~ 393:12930) — 입력창에 직접 써서 시작하는 대화
 *
 * 세 흐름이 각각 다른 페이지가 아니라 **하나의 채팅 화면**입니다.
 * [9-2]와 [9-3]은 **첫 요청을 어떻게 넣느냐만 다르고 이후 대화는 같습니다** —
 * [9-2]는 요청 예시 버튼, [9-3]은 직접 입력(393:12495 "이런 식으로 수정하고 싶어요.").
